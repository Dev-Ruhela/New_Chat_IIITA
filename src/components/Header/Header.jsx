...
function Header() {
    const { isAuthenticated, user } = useAuthStore1();

    const {signIn , signOut} = useAuthStore1();
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                <NavLink
                                    // to="/login"
                                    onClick={handleLogin}
                                    className="flex items-center text-gray-800 dark:text-white rounded-lg px-3 py-2 text-sm"
                                >
                                    <span className='flex items-center justify-center bg-blue-700 bg-opacity-30 text-black dark:bg-gray-100 dark:text-black p-3 rounded-lg'> <LogInIcon className='h-4 w-4 mr-2' /> Login With Google</span>
                                </NavLink>
                                {/* <Link
                                    onClick={handleLogin}
